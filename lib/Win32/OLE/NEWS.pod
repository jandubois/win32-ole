...
format.  This has been changed to return a Win32::OLE::Variant
object. The return values will behave as before when being used as
strings or numbers due to the overloaded behavior of the Variant objects.
