...
modules. Only new features and major bug fixes that might affect backwards
...
=head2 WithEvents() supports COCLASS name as 3rd arg

=head2 Forwarder objects
...
value is +/-79,228,162,514,264,337,593,543,950,335.  With a 28
decimal places, the largest value is +/-7.9228162514264337593543950335
and the smallest, non-zero value is +/-0.0000000000000000000000000001.

=head2 numerical Variant operations overloaded

Addition, subtraction, multiplication and division of variants are now
overloaded.  This means that the variant values are not converted into
Perls numbers first.  Therefore the additional precision of
e.g. VT_DECIMAL variants is maintained:

  perl -MWin32::OLE::Variant -e"print Variant(VT_DECIMAL,
                                '79228162514264337593543950335')-1"

prints the number 79228162514264337593543950334.
